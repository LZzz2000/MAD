...
class Debate:
    ...
    def creat_agents(self):
        ...
        self.judge_player = DebatePlayer(model_name=self.model_name, name='Judge', temperature=self.temperature,
                                         google_api_key=self.google_api_key, sleep_time=self.sleep_time)
    ...
    def init_agents(self):
        ...
        self.negative.memory_lst = self.negative.memory_lst + self.config['negative_prompt'].replace('##oppo_ans##',
                                                                                                     self.dict_aff_ans[
                                                                                                         'Answer']).replace('##oppo_reason##',
                                                                                                     self.dict_aff_ans[
                                                                                                         'Reason'])

        self.neg_ans = self.negative.ask(self.img).lstrip()
        print(json.dumps(self.neg_ans))
    ...
    def run(self):
        ...
        for round in range(self.max_round - 1):
            if self.dict_aff_ans['Answer'] == self.dict_neg_ans['Answer']:
                ...
                print(json.dumps(self.say_yes_ans))
                ...
                if self.say_yes_side.above == 'nothing':
                ...
                if self.say_yes_side.below == 'nothing':
                ...
                if self.say_yes_side.right_side == 'nothing':
                ...
                if self.say_yes_side.left_side == 'nothing':
                    self.config['say_no_side_probe1'] = self.config['say_no_side_probe1'].replace(
                ...
                print(json.dumps(self.say_no_ans))
                ...
                if self.say_no_dict_ans['What is it'] == self.config['object'] or self.say_no_dict_ans[
                    'What is it'].find(self.config['object']) != -1 or self.config['object'].find(
                        self.say_no_dict_ans['What is it']) != -1 or kkk.find('Yes') != -1 or kkk.find('yes') != -1:
                ...
                if self.say_yes_dict_ans['What is it'] == self.config['other_object'] or self.say_yes_dict_ans[
                    'What is it'].find(self.config['other_object']) != -1 or self.config['other_object'].find(
                        self.say_yes_dict_ans['What is it']) != -1 or kkk1.find('Yes') != -1 or kkk1.find('yes') != -1:
                    ...
                    'What is it'].find(self.config['object']) != -1 or self.config['object'].find(
                        self.say_yes_dict_ans['What is it']) != -1 or kkk2.find('Yes') != -1 or kkk2.find('yes') != -1:
                    ...
                    print(json.dumps(self.judge_ans))
                    ...
                    if self.judge_dict_ans['Which object does judge believe'] == self.config['object'] or \
                            ...
                            self.config['object'].find(
                                    self.judge_dict_ans['Which object does judge believe']) != -1 or kkk3.find(
                            'Yes') != -1 or kkk3.find('yes') != -1:
                        self.config["debateAnswer"] = "Yes"
                        ...
                        self.config['success'] = True
                            ...
                            self.judge_dict_ans['Which object does judge believe']) != -1 or kkk4.find(
                            'Yes') != -1 or kkk4.find('yes') != -1:
                        self.config["debateAnswer"] = "No"
                        self.config["Reason"] = self.judge_dict_ans['Reason']
                        self.config['success'] = True
                    break
